                        ...
                        <div class="col-6">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 d-flex align-items-center">
                                    <li class="breadcrumb-item"><a href="adminDashboard.php" class="link"><i class="bi bi-gift"></i></a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Manage Orders</li>
                                </ol>
                            </nav>
                            <h1 class="mb-0 fw-bold">Manage Orders</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-md-flex">
                                        <div>
                                            <h4 class="card-title fw-bolder text-dark fs-1"> <i class="bi bi-gift"></i></h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover align-middle text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                $r1 = Database::search("SELECT *  FROM  `invoice` ORDER BY `date` DESC ");
                                                $n = $r1->num_rows;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($status == 0) {
                                                            ?>
                                                                <button class="btn btn-info text-white" onclick="changeInvoiceStatus(<?php echo $order['id']?>)"id="btn<?php echo $order['id'] ?>" >Processing <i class="bi bi-arrow-clockwise "></i></button>

                                                            <?php
                                                            } else if ($status == 1) {
                                                            ?>
                                                                <button class="btn btn-orange text-white" onclick="changeInvoiceStatus(<?php echo $order['id']?>)"id="btn<?php echo $order['id'] ?>">Shipped   <i class="bi bi-box "></i>
                                                            ...
                                                            ?>
                                                                <button class="btn btn-success text-white " onclick="changeInvoiceStatus(<?php echo $order['id']?>)"id="btn<?php echo $order['id'] ?>">In Transit <i class="fs-6 bi bi-truck "></i>
                                                                </button>
                                                            <?php
                                                            } elseif ($status == 3) {
                                                            ?>

                                                                <button class="btn btn-secondary text-white disabled" >Delivered <i class="bi bi-house "id="btn<?php echo $order['id'] ?>"></i>
                                                                </button><?php
                                                                        }
                                                                            ?>
