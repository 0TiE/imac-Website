                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-md-flex">
                                        <div>
                                            <h4 class="card-title fw-bolder text-dark fs-1"> <i class="bi bi-people"></i></h4>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                                <button class="btn btn-dark" onclick="userBlock('<?php echo $s['email'] ?>');">Block</button>
                                                            <?php
                                                            } else if ($status == 2) {
                                                            ?>
                                                                <button class="btn btn-dark" onclick="userBlock('<?php echo $s['email'] ?>');">UnBlock</button>
